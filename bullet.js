...
class Bullet {
  ...
  update() {
    ...
    for (var i = 0; i < this.gameEngine.entities.length; i++) {
      ...
      if ((ent instanceof Tower) && (this.shootingEntity instanceof Enemy) && collide(this, ent)) {
        ent.takeHit(this.shootingEntity.damage);
        this.removeFromWorld = true;
      } 

      if ((ent instanceof Enemy) && (this.shootingEntity instanceof Tower) && collide(this, ent)) {
        ent.takeHit(this.shootingEntity.damage);
        this.removeFromWorld = true;
      }
    }
