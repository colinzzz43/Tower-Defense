...
- towerTeam: boolean, true = isTower, false = isEnemy
*/
class Bullet {

  constructor(game, x, y, bulletProperties, target, towerTeam) {
    Object.assign(this, { game, x, y, bulletProperties, target, towerTeam});

    this.radius = bulletProperties.width/2;

    this.spritesheet = ASSET_MANAGER.getAsset(bulletProperties.asset);
