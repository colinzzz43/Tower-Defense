class Mushroom extends Enemy {
    constructor(gameEngine, x, y, level, spawnTime) {
      ...
      // sprites
      this.attackImg = ASSET_MANAGER.getAsset("./sprites/monster/mushroom/Attack.png");
      this.deathImg = ASSET_MANAGER.getAsset("./sprites/monster/mushroom/Death.png");
      this.runImg = ASSET_MANAGER.getAsset("./sprites/monster/mushroom/Run.png");
      this.takehitImg = ASSET_MANAGER.getAsset("./sprites/monster/mushroom/Take Hit.png");
  
      // animations
      this.attackAnim = new Animator(this.attackImg, 0, 0, 150, 150, 8, 0.15, 0, false, true);
      this.deathAnim = new Animator(this.deathImg, 0, 0, 150, 150, 4, 0.3, 0, false, true);
      this.runAnim = new Animator(this.runImg, 0, 0, 150, 150, 8, 0.1, 0, false, true);
      this.takehitAnim = new Animator(this.takehitImg, 0, 0, 150, 150, 4, 0.1, 0, false, true);
      this.loadAnimation();
