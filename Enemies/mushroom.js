class Mushroom extends Enemy {
  constructor(gameEngine, x, y, direction, level, spawnTime) {
    ...
    this.runImg = ASSET_MANAGER.getAsset(
      "./sprites/monster/mushroom/Run.png");

    this.attackLeftImg = ASSET_MANAGER.getAsset(
      "./sprites/monster/mushroom/Attack_Left.png");
    this.deathLeftImg = ASSET_MANAGER.getAsset(
      "./sprites/monster/mushroom/Death_Left.png");
    this.runLeftImg = ASSET_MANAGER.getAsset(
      "./sprites/monster/mushroom/Run_Left.png");

    // animations
    this.attackAnim = new Animator(this.attackImg, 0, 0, 150, 150, 8, 0.2, 0,
      false, true);
    this.deathAnim = new Animator(this.deathImg, 0, 0, 150, 150, 4, 0.3, 0,
      false, false);
    this.runAnim = new Animator(this.runImg, 0, 0, 150, 150, 8, 0.1, 0, false,
      true);

    this.attackLeftAnim = new Animator(this.attackLeftImg, 0, 0, 150, 150, 8, 0.2, 1,
      false, true);
    this.deathLeftAnim = new Animator(this.deathLeftImg, 0, 0, 150, 150, 4, 0.3, 1,
      false, false);
    this.runLeftAnim = new Animator(this.runLeftImg, 0, 0, 150, 150, 8, 0.1, 1, false,
      true);
