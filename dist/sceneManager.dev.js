...
function () {
  function SceneManager(game, ctx) {
    ...
    this.coinAnimation = new Animator(ASSET_MANAGER.getAsset("./sprites/other/coin2.png"), 0, 0, 16, 16, 8, 0.2, 0, false, true); //  this.user = this.game.user;
    //	this.base = this.game.base;

    this.currentWave = 0;
    this.scores = 0;
    this.height = 480; // Level Map Screen
  ...
  _createClass(SceneManager, [{
    ...
    */
    value: function draw(ctx) {
      ...
      this.coinAnimation.drawFrame(this.game.clockTick, ctx, this.levelMap.xCanvas + this.levelMap.width * 0.335, this.levelMap.yCanvas + this.levelMap.height * 0.82, 3);
