...
ASSET_MANAGER.queueDownload("./sprites/monster/dragons/flying_twin_headed_dragon-red.png"); // towers + base
...
ASSET_MANAGER.queueDownload("./sprites/towers/spazer/Level1/1_left.png"); // bullets
...
ASSET_MANAGER.downloadAll(function () {
  ...
  var level = new Level(gameEngine, map, 0, 0, 0, 0, 600, 400, 1.5, 1, ctx); // tower icon buttons
  ...
  var x = 80;
  var y = 330;
  var initalSpawnTime = 1;
  var interval = 2;
  var n = 2; // addEnemySpawn(gameEngine, x, y, level, initalSpawnTime, interval, "Slime", n);
  //  x = 80;
  //  y = 330;
  //  initalSpawnTime = 5;
  //  interval = 2;
  ...
  addEnemySpawn(gameEngine, x, y, level, initalSpawnTime, interval, "Flying Eye", n); //  x = 80;
  //  y = 330;
  //  initalSpawnTime = 10;
  //  interval = 2;
  //  n = 2;
